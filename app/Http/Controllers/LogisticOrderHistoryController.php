...
class LogisticOrderHistoryController extends Controller
{
    /**
     * FRONTEND-ONLY page. No DB calls yet.
     * We pass dummy data to render the UI.
     */
    public function index(Request $request)
    {
        ...
        return view('logistic.order_history', compact('orders', 'pagination'));
    }
}
