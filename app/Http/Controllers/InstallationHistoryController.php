...
class InstallationHistoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        $yearValueExpr = "CAST(COALESCE(YEAR(o.orderDate), YEAR(o.created_at)) AS CHAR)";
                ...
                function ($qb) use ($pid, $formattedCodeExpr) {
                    ...
                    $qb->where(function ($w) use ($pid, $like, $formattedCodeExpr) {
                        ...
                        $w->orWhere('o.id', 'like', $like)
                            ...
                            // Match the formatted code without the trailing R.
                            ->orWhere(
        ...
        // Attach details URL used by row double-click.
