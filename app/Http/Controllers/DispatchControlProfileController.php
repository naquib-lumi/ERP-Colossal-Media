...
class DispatchControlProfileController extends Controller
{
    // GET /dispatch/profile  (view page; add ?edit=1 to show the form)
    public function index(Request $request)
    {
        $user = Auth::user();
        return view('dispatchcontrol.user', compact('user'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('dispatchcontrol.user')->with('status', 'Profile updated successfully.');
    }
}
