        ...
        <div class="card-body">
          ...
          <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
            ...
            <div id="ordersToolbar" class="d-flex align-items-center gap-2 flex-wrap">
              ...
              <a href="{{ route('admin.orders') }}" class="btn btn-outline-secondary">Reset</a>
              <button id="exportExcel" type="button" class="btn btn-dark">
                <i class="bx bx-export me-1"></i> Export
              </button>
              <!-- <a href="{{ route('admin.orders.create') }}" class="btn btn-light text-primary">Add Order</a> -->
            </div>
          </div>

          <div class="w-100 border rounded-3 px-3 py-3">
            <!-- 第一排：Order ID + Salesperson + Search + Status -->
            <form id="ordersFilterForm" method="GET" action="{{ route('admin.orders') }}">
...
<script>
  ...
  (function() {
    ...
    const form = document.getElementById('ordersFilterForm') || document.querySelector('form[action*="admin/orders"]');
    if (!form) return;
