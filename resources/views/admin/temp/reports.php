  ...
  <div class="section active" id="salesSec">
    ...
    <div class="p-3 border-bottom">
      <form id="sales-filters">
        <input type="hidden" name="_token" value="YQRkRC0BaX4pShivAxA7bOu6OcI8omFwEjpB4qbU" autocomplete="off">        <div class="row g-3 align-items-end">
          <div class="col-md-3">
            ...
            <select class="form-select" name="salesperson" id="salesperson">
              <option value="All Salespersons">All Salespersons</option>
                              <option value="15">Head Sales Person 1</option>
                              <option value="16">Head Sales Person 2</option>
                              <option value="1">Sales Person 1</option>
                              <option value="2">Sales Person 2</option>
                          </select>
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-4">
            ...
            <div class="d-flex align-items-center gap-2">
              <input type="date" name="start_date" id="sales-start-date" class="form-control" value="2025-10-01">
              <span class="text-muted small">to</span>
              <input type="date" name="end_date" id="sales-end-date" class="form-control" value="2025-10-31">
            </div>
          </div>
          <div class="col-md-2 text-md-end d-flex gap-2">
            ...
            <button type="submit" formaction="https://dev.colossal360.com.my/admin/reports/export-sales" class="btn btn-dark-compact btn-sm-compact">
            ...
            <div class="outcomes-grid">
              ...
              <aside class="sidebar">
                <form id="outcomes-filters" class="filter-stack d-flex flex-column gap-3">
                  <input type="hidden" name="_token" value="YQRkRC0BaX4pShivAxA7bOu6OcI8omFwEjpB4qbU" autocomplete="off">                  <div>
                    <div class="label">Start date</div>
                    <input type="date" name="start_date" id="outcomes-start-date" class="form-control" value="2025-10-01">
                  </div>
                  <div>
                    <div class="label">End date</div>
                    <input type="date" name="end_date" id="outcomes-end-date" class="form-control" value="2025-10-31">
                  </div>
                  <div>
        ...
        <input type="hidden" name="_token" value="YQRkRC0BaX4pShivAxA7bOu6OcI8omFwEjpB4qbU" autocomplete="off">        <div class="row g-3 align-items-end">
          ...
          <div class="col-md-5">
            ...
            <div class="d-flex gap-2">
              <input type="date" name="start_date" id="order-start-date" class="form-control" value="2025-10-01">
              <input type="date" name="end_date" id="order-end-date" class="form-control" value="2025-10-31">
            </div>
          </div>
          <div class="col-md-2 ms-auto text-md-end d-flex gap-2">
            ...
            <button type="submit" formaction="https://dev.colossal360.com.my/admin/reports/export-orders" class="btn btn-dark-compact btn-sm-compact">
              <i class="bi bi-download me-1"></i> Export
            </button>
          </div>
        </div>
...
document.getElementById('sales-generate').addEventListener('click', () => {
  ...
  fetch('https://dev.colossal360.com.my/admin/reports/sales-kpis', {
    method: 'POST',
    body: formData,
    headers: { 'X-CSRF-TOKEN': 'YQRkRC0BaX4pShivAxA7bOu6OcI8omFwEjpB4qbU' }
  })
    .then(res => res.json())
    .then(data => {
...
document.getElementById('mpMonth').addEventListener('change', (e) => {
  ...
  fetch('https://dev.colossal360.com.my/admin/reports/sales-monthly', {
    method: 'POST',
    body: formData,
    headers: { 'X-CSRF-TOKEN': 'YQRkRC0BaX4pShivAxA7bOu6OcI8omFwEjpB4qbU' }
  })
...
document.getElementById('outcomes-generate').addEventListener('click', () => {
  ...
  fetch('https://dev.colossal360.com.my/admin/reports/sales-outcomes', {
    method: 'POST',
    body: formData,
    headers: { 'X-CSRF-TOKEN': 'YQRkRC0BaX4pShivAxA7bOu6OcI8omFwEjpB4qbU' }
  })
...
document.getElementById('order-generate').addEventListener('click', () => {
  ...
  fetch('https://dev.colossal360.com.my/admin/reports/order-fulfillment', {
    method: 'POST',
    body: formData,
    headers: { 'X-CSRF-TOKEN': 'YQRkRC0BaX4pShivAxA7bOu6OcI8omFwEjpB4qbU' }
  })
