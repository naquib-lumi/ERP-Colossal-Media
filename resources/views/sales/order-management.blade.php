...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    ...
    <div class="card-datatable table-responsive p-3">
      ...
      {{-- DataTables 的底部(info + length + paginate)由 dom 配置生成，无需手写 --}}
    </div>
  </div>
</div>
...
$(function () {
  ...
  let table = $('#orderTable').DataTable({
    ...
    // ✅ 把底部改成：左边(info + length)，右边(paginate)
    dom: 'rt<"dt-bottom d-flex justify-content-between align-items-center mt-3"<"dt-left d-flex align-items-center gap-3"i l><"dt-right"p>>',

    // ✅ length 菜单的文案：_MENU_ entries per page
    language: {
      lengthMenu: '_MENU_ entries per page'
      // 如需自定义 info：info: 'Showing _START_ to _END_ of _TOTAL_ entries'
    },
