...
<style>
  ...
  .table{width:100%;min-width:1100px;border-collapse:separate;border-spacing:0;table-layout:auto}
      ...
      <table class="table align-middle mb-0">
        ...
        @forelse ($jobs as $j)
          ...
          <tr id="job-{{ $j->ProductID }}"
            ...
            <td class="whitespace-nowrap font-medium col-product-id">{{ $j->display_product_id }}</td>
            <td>{{ $j->order_title ?? '—' }}</td>
