...
<style>
  ...
  .col-cutter{width:180px}.col-assemble{width:110px}
  ...
  .is-editing .td-cutter .view-text{display:none}
  .is-editing .td-cutter .edit-input{display:block}
...
<div class="container-fluid py-4 px-4">
  <div class="page-wrap" id="pageRoot">
    {{-- 顶部 --}}
    @php
      $assignee = $assignee ?? 'Staff A';
      $uploader = $uploader ?? 'Artist A';
    @endphp
