...
<style>
  ...
  .col-cutter{width:180px}      /* 让 Cutter 有更宽空间 */
  ...
  /* 折叠按钮 */
  .btn-toggle{border:1px solid #E5E7EB;background:#fff;border-radius:10px;padding:6px 10px;font-size:12px;color:#475467;display:inline-flex;align-items:center;gap:6px}
  .btn-toggle .bi{transition:transform .2s ease}
  .btn-toggle.open .bi{transform:rotate(180deg)}

  /* Delivery cards（同上一个版本） */
  ...
  <div class="page-wrap" id="pageRoot">
      ...
      <div class="card-body">
        ...
        <div class="subcard mb-3">
          <div class="subcard-head">
            ...
            <div class="right">
              <button class="btn-toggle open" data-toggle="subcard" data-target="p1-body">
        ...
        <div class="subcard">
          <div class="subcard-head">
            ...
            <div class="right">
              <button class="btn-toggle open" data-toggle="subcard" data-target="p2-body">
                <i class="bi bi-caret-down-fill"></i> Toggle
              </button>
            </div>
          </div>
    ...
    <div class="actionbar">
      <div class="d-flex justify-content-end gap-2">
        <div class="view-only d-flex gap-2">
          <button type="button" id="btnEdit" class="btn btn-light border btn-pill">Edit</button>
          <a href="javascript:history.back()" class="btn btn-dark btn-pill">Back</a>
        </div>
        <div class="edit-only d-flex gap-2">
...
<script>
  // 折叠
  document.querySelectorAll('[data-toggle="subcard"]').forEach(function(btn){
  ...
  (function(){
    ...
    function createRow(){
      ...
      div.className = 'remark-row d-flex align-items-center gap-2';
      div.innerHTML = `
        <select class="form-select form-select-sm remark-cat" style="max-width:160px">
          <option>Installation</option>
          <option>Printing</option>
    ...
    btn?.addEventListener('click', () => list.appendChild(createRow()));
    list?.addEventListener('click', (e) => {
      const r = e.target.closest('.remove-remark');
      if (!r) return;
      const row = r.closest('.remark-row');
