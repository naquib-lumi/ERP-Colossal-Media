...
<div class="container-fluid">
  ...
  {{-- Single flash success (no duplicates) --}}
  @if (session('status'))
  ...
  {{-- Slide-down edit panel (posts to FurnishingProfileController@update) --}}
  <div id="profileEditWrap" class="mt-3">
    ...
    >
      <div class="card-body">
        <form method="POST" action="{{ route('furnishing.profile.update') }}" novalidate>
          @csrf
          @method('PUT')
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Auto-open pwd section on validation errors / old inputs
