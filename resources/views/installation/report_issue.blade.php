...
<div class="container-fluid py-4 px-4">
  <div class="page-wrap">
    ...
    <div class="d-flex align-items-center gap-2 mb-3">
      <a href="{{ route('installation.dashboard') }}" class="text-decoration-none text-muted">
    ...
    <div class="card soft">
      <div class="card-body">
        ...
        <form id="issueForm"
              method="POST"
              action="{{ route('installation.report.submit', ['productId' => $productId ?? request()->route('productId')]) }}"
              novalidate>
          @csrf
          ...
          <div class="actionbar">
            <div class="bar">
              <a href="{{ route('installation.dashboard') }}" class="btn btn-light border btn-pill">Cancel</a>
