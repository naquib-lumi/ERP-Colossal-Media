...
<style>
  ...
  .edit-panel.open{
    ...
    max-height:520px; /* enough to contain the form; adjust if needed */
...
<div class="container-fluid">
  ...
  {{-- SINGLE flash block (only one alert shown) --}}
  @if (session('status'))
  ...
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      @php
        // you can map a real status if you store it; 'Active' is shown in your UI
        $status = 'Active';
    ...
    <div class="card-body">
      <div class="row align-items-center">
        {{-- Avatar (use your preferred source) --}}
        <div class="col-auto">
          <img
  ...
  <div id="profileEditWrap" class="mt-3">
    ...
    >
      <div class="card-body">
        <form method="POST" action="{{ route('printing.profile.update') }}" novalidate>
          @csrf
          @method('PUT')
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const openPwd = (open) => {
    ...
    // keep outer panel in sync while inner section animates
    let ticks = 0;
  ...
  // initial state (open if there are validation errors)
  if (panel.classList.contains('open')) {
    syncPanelHeight();
  }

  // auto-open password section if validation failed before
