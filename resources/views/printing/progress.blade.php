    ...
    <div class="card-body">
      <form method="GET" action="{{ route('printing.progress') }}">
        ...
        <div class="filter-head">
          <div class="title">
            <h6 class="mb-0 fw-semibold">Printing</h6>
          ...
          <div class="actions">
            ...
            <a href="{{ route('printing.progress') }}" class="btn btn-outline-secondary">
          ...
          <tr>
            ...
            @php
              ...
              $urlWith = function(array $overrides) use ($q) {
                return route('printing.progress', array_filter(array_merge($q, $overrides), fn($v)=>$v!==null && $v!==''));
              };
              // for actions sort
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.clickable-row').forEach(row => {
    row.addEventListener('dblclick', () => {
      ...
      if (id) window.location.href = `/printing/jobs/${id}`;
    });
  });
});
