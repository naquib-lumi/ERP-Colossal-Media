...
<div class="container py-4">
  ...
  <div class="card-body">
    ...
    <form action="{{ route('boss.fulfillment.deliveries.update', $product->ProductID ?? $productId ?? $order->id) }}"
  ...
  <div class="card soft mb-4">
    <div class="card-body">
          ...
          @foreach($product->remarks as $r)
            ...
            <div class="remark-card">
              ...
              <div class="remark-body">
                ...
                @if($canManage)
                  <form method="POST"
                        action="{{ route('boss.fulfillment.remarks.update', [$productKey, $r->RemarkID]) }}"
              ...
              @if($canManage)
                <div class="remark-actions ms-auto d-flex flex-column align-items-end">
                  ...
                  <form method="POST"
                        action="{{ route('boss.fulfillment.remarks.destroy', [$productKey, $r->RemarkID]) }}"
      ...
      @if(auth()->check())
        <form method="POST"
              action="{{ route('boss.fulfillment.remarks.store', $productKey) }}"
              class="mt-3 d-none"
              id="addRemarkForm">
          @csrf
