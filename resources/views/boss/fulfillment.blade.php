...
<div class="card mb-4">
  <div class="card-body toolbar">
    <form id="ff-filter-form" method="GET" action="{{ route('boss.fulfillment') }}" class="row g-2 align-items-center">
      ...
      <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
        ...
        <div class="d-flex align-items-center gap-2 flex-wrap">
          ...
          <a href="{{ route('boss.fulfillment') }}" class="btn btn-outline-secondary">Reset</a>
        </div>
      </div>
        ...
        <thead class="table-light">
          <tr>
            ...
            @php
              ...
              $permitUrl = route('boss.fulfillment', array_merge($q, [
                'sort' => 'permit',
                'dir'  => $nextDir,
              ]));
...
<div class="modal fade" id="permitModal" tabindex="-1" aria-labelledby="permitModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md modal-dialog-centered">
    <div class="modal-content">
      <form id="permitForm" method="POST" action="{{ route('boss.fulfillment.permit.store') }}" enctype="multipart/form-data">
        @csrf
