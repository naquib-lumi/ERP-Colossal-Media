...
<div class="container-fluid">
  ...
  <div class="card">
      ...
      <div class="card-body">
          <div class="row align-items-center">
              {{-- Avatar (keep your asset or swap to initials if you prefer) --}}
              <div class="col-auto">
                  <img
  ...
  {{-- Slide-down edit panel (posts to backend) --}}
  <div id="profileEditWrap" class="mt-3">
      ...
      >
          <div class="card-body">
              <form method="POST" action="{{ route('dispatchcontrol.user.update') }}" novalidate>
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row g-4">
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                          ...
                          <div class="form-check form-switch ms-3">
                              {{-- IMPORTANT: name="change_password" to trigger required_with rules --}}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Open password section automatically if there were validation errors / old inputs
