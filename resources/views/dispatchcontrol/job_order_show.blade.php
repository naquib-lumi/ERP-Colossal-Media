...
<div class="container-fluid py-4 px-4">
  <div class="page-wrap" id="pageRoot">
    ...
    @php
      $from = request('from');
      $backUrl = match ($from) {
        'history'   => route('dispatchcontrol.history'),
        'dashboard' => route('dispatchcontrol.dashboard'),
      ...
      <div class="card-body">
        ...
        <div class="row g-4">
          <div class="col-12 col-lg-6">
            <dl class="dl">
              <dt>Job Order ID</dt>
              <dd>{{ $job_order_code ?? ($header->order_number ?: '—') }}</dd>
              <dt>Job Title</dt>
        ...
        <div class="toolbar">
          ...
          @if ($isAccepted && $canEditThisStage && !$isCompleted)
            <div class="toolbar">
              ...
              <a href="{{ route('dispatchcontrol.dashboard') }}" class="btn btn-accept">
