              ...
              <tr class="js-row-open" data-href="{{ $row->details_url }}" style="cursor:pointer;">
                ...
                <td>
                  <button
                    ...
                    data-url="{{ route('dispatchcontrol.history.proofs', ['product' => $row->ProductID ?? $row['ProductID']]) }}"
                    data-upload-url="{{ route('dispatchcontrol.history.proofs.store', ['product' => $row->ProductID ?? $row['ProductID']]) }}"
                  >
  ...
  <div class="cx-wrap">
    <div class="cx-modal cx-lightbox" role="dialog" aria-modal="true" aria-labelledby="proofTitle">
      <div class="cx-header">
        ...
        <div id="proofTitle" class="cx-title">Dispatch Control Proof</div>
