...
<style>
    ...
    .edit-panel.open {
        ...
        max-height: 520px;
        /* large enough for the form; adjust if you add more fields */
...
<div class="container-fluid">
    ...
    <div id="profileEditWrap" class="mt-3">
        <div id="editPanel" class="card edit-panel @if($errors->any()) open @endif" aria-hidden="@if($errors->any()) false @else true @endif">
            <div class="card-body">
                <form method="POST" action="{{ route('artist.profile.update') }}" novalidate>
                    @csrf
                    @method('PATCH')
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="password" name="password"
                                        ...
                                        autocomplete="new-password" placeholder="Min 8, mix case, number, symbol">
